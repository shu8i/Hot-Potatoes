...
public abstract class Constants {
	...
	public static final String DATABASE = "data" + File.separator
			+ "database.dat";
	public static final String DEFAULT_USERNAME = "root",
			DEFAULT_PASSWORD = "admin";

	public static final Font FONT_OPEN_SANS_14 = new Font("Open Sans",
			Font.PLAIN, 14);
	public static final Font FONT_OPEN_SANS_20 = new Font("Open Sans",
			Font.PLAIN, 20);
