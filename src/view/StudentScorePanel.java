...
public class StudentScorePanel extends JPanel {
	...
	public StudentScorePanel(JFrame parent, LoginPanel loginPanel,
			ScorePanel predecessor, Controller controller, String gridName) {
		super(layout);
		...
		Map<String, Integer> scores = Controller.getGridScores(gridName);
