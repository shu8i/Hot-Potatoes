...
public class CodePanel extends JScrollPane {
	...
	public void addCodeBlock(CodeBlock codeBlock) {
		...
		case IF:
		case WHILE:
			codeBlockPanel = new CodeBlockPanel(codeBlock.getCodetext(),
					codeBlock.getId(), this.controller, this.playPanel);
			...
			if (codeBlock.getCondition() != null) {
				this.c.gridx = this.col;
				codeBlockPanel = new CodeBlockPanel(codeBlock.getCondition(),
						codeBlock.getId(), this.controller, this.playPanel);

				if (this.current) {
					codeBlockPanel
							.updateBorderColor(Constants.COLOR_DARK_GREEN);
				}
		...
		case ELSE:
			this.c.gridx = --this.col;
			codeBlockPanel = new CodeBlockPanel("ELSE", codeBlock.getId(),
					this.controller, this.playPanel);
		...
		case END:
			this.c.gridx = --this.col;
			codeBlockPanel = new CodeBlockPanel("END", codeBlock.getId(),
					this.controller, this.playPanel);
