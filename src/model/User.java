...
public class User implements Serializable {
	 ...
	 * @param isAdmin
	 *            whether this account is designated as an admin account
	 */
	 ...
	 * 
	 * @param password
	 *            the new password (will be encrypted)
	 * @return this user account
	 */
	 ...
	 *            of the macro
	 * @param code
	 *            that the macro will include
	 * @param panelMode
	 *            the current mode of the panel
	 * @return User with the macro added
	 */
	public User addMacro(String name, Code code,
	...
	/**
	 * @param name
	 * @return the code of the macro specified in the name if it does not exists
	 *         it will return null
	 */
