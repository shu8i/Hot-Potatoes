...
public class UserController {
	...
	/**
	 * Attempts to login a user. Calls DatabaseController and loads the list of
	 * existing user accounts. If the username/password is valid, it'll get the
	 * user's GameController.
	 * 
	 * @param username
	 *            the username
	 * @param password
	 *            the password
	 * @return null if the login was unsuccessful GameController of the logged
	 *         in user, if login was successful
	 */
	 ...
	 *            the password
	 * @param isAdmin
	 *            whether the new user has admin priviliges
	...
	public UserController addMacro(String name, Code code,
		...
		if (code.isEmpty() || panelMode == null)
			throw new IllegalArgumentException("There's nothing to save!");
